  ...
  return (
    <Card className="p-6 flex flex-col justify-between border-l-4 border-l-violet-500 relative overflow-hidden">
      <div>
        ...
        <div className="mt-4">
             <div className="flex justify-between text-xs mb-1">
                ...
                <span className="text-muted-foreground">${(budgetLimit - currentSpend).toFixed(2)} remaining</span>
             </div>
      ...
      <div className="mt-4 text-xs text-muted-foreground">
        {isOverLimit ? "Limit exceeded. Service access may be restricted." : "Budget cycle resets on 1st of next month."}
      </div>
    </Card>
  );
}
